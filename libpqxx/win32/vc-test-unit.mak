...
CXX_FLAGS_BASE=/nologo /W3 /EHsc /FD /GR /c \
    ...
    /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "_WINDOWS" /D "NOMINMAX" $(PQXX_SHARED)
...
$(INTDIR)\test_stream_from.obj:
	@$(CXX) $(CXX_FLAGS) test/unit/test_stream_from.cxx /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\"
$(INTDIR)\test_stream_to.obj:
	@$(CXX) $(CXX_FLAGS) test/unit/test_stream_to.cxx /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\"
$(INTDIR)\test_string_conversion.obj:
